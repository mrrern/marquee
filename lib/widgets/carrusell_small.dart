...
class CarruselN extends ConsumerStatefulWidget {
  const CarruselN({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CarruselNState();
}

class _CarruselNState extends ConsumerState<CarruselN> {
  late Timer timer; // Timer para cambiar la imagen automáticamente
