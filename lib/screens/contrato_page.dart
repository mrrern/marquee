        ...
        children: [
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(top: 7.0, left: 16.0, right: 16.0),
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => context.go('/'), // Navigate back using go_router
                      child: const Text(
                        'Salir',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: const Color.fromRGBO(217, 217, 217, 0.93),
